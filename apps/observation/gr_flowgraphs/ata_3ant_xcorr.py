...
class ata_3ant_xcorr(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "ATA 3 Antenna XEngine")
        ...
        # Blocks
        ##################################################
        self.clenabled_clXEngine_0 = clenabled.clXEngine(1,1,0,0,False, 6, 2, 3, 1, starting_channel, num_channels, 10000, True,output_file,0)
        ...
        self.ata_SNAPSynchronizerV3_0 = ata.SNAPSynchronizerV3(3, num_channels)
...
def main(top_block_cls=ata_3ant_xcorr, options=None):
